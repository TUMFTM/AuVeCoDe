function [vehicle,Parameters] = initialize_inputparameters_model3rwd(vehicle)
...
% Version: Matlab2020b
%-------------
% Description: Tesla Model 3 Standard Range Plus RWD 2020
...
vehicle.Input.vehicle_empty_weight      =   1684-75;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
vehicle.Input.r_tire                    =   334;            %static tire radius in mm 
vehicle.Input.w_tire                    =   235;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.dimensions.GY.vehicle_width     =   1850;           %vehicle width in mm
vehicle.dimensions.GZ.vehicle_height    =   1443;           %vehicle height in mm
vehicle.dimensions.GX.wheelbase         =   2875;           %wheelbase in mm
vehicle.Input.driving_cycle             =   'TM3_WLTP_measured';         %driving cycle (cycle are in folder 04_Drive_Cycle)
...
vehicle.Input.max_speed                 =   225;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_r               =   9;         %gear ratio rear
...
vehicle.Input.acceleration_time_req     =   5.6;    %required acceleration time in s
...
vehicle.Input.c_d                       =   0.23;            %air resistance coefficient, (optional)
...
Parameters.LDS.eta_differential         =   0.98;      %efficiency of differential in [-]. Source [5]
...
Parameters.LDS.eta_battery              =   1;                              %fix efficiency of battery in [-]. Source [8] 0.92
Parameters.LDS.eta_power_electronics    =   0.94;                           %efficiency of power electronics in [-]. Source [6]
