function [vehicle,Parameters] = initialize_inputparameters_egolf2020(vehicle)
...
vehicle.Input.vehicle_empty_weight      =   1615-75;      %empty weight netto in kg (no driver) %1400 / 1698.2-75
...
vehicle.dimensions.GY.vehicle_width     =   1799;           %vehicle width in mm
vehicle.dimensions.GZ.vehicle_height    =   1482;           %vehicle height in mm
vehicle.dimensions.GX.wheelbase         =   2629;           %wheelbase in mm
vehicle.Input.driving_cycle             =   'WLTP';         %driving cycle (cycle are in folder 04_Drive_Cycle) %egolf_d3_0xx
vehicle.Input.power_auxiliaries         =    0.3;           %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.max_speed                 =   150;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   9.76;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  290;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   9.6;    %required acceleration time in s
...
vehicle.Input.c_d                       =   0.281;            %air resistance coefficient, (optional)
...
Parameters.masses.loads.axle_load_front.FWD = 55;                %Axle load distribution for RWD vehicles in percent
...
Parameters.LDS.correction_gearbox       =   0.9142;       %correction factor for gear ratio (for electric vehicles) in [-]. Source [3] %0.86
...
Parameters.LDS.eta_power_electronics    =   0.95;                           %efficiency of power electronics in [-]. Source [6]0.95
...
Parameters.LDS.delta_t_con              =   0.1;                            %step size in consumption simulation in s or NaN
