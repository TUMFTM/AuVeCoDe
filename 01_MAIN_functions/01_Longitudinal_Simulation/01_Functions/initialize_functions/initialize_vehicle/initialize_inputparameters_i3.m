function [vehicle,Parameters] = initialize_inputparameters_i3(vehicle)
...
vehicle.Input.w_tire                    =   155;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.dimensions.GY.vehicle_width     =   1775;           %vehicle width in mm
vehicle.dimensions.GZ.vehicle_height    =   1578;           %vehicle height in mm
vehicle.dimensions.GX.wheelbase         =   2570;           %wheelbase in mm
...
vehicle.Input.i_gearbox_r               =   9.66;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  NaN;         %max torque of front machine in Nm
vehicle.Input.T_max_Mot_r               =  250;         %max torque of rear machine in Nm
...
vehicle.Input.acceleration_time_req     =   8.1;    %required acceleration time in s

%Motor characteristic inputs
vehicle.Input.characteristic_forced = {NaN,'PSM_M250_n11400_0.4.mat'};  %select forced characteristic per axle, otherwise NaN, f.e. characteristic_forced = {'PSM_M270_n12000_0.2.mat',NaN};
...
vehicle.Input.eta_gearbox_r             =   0.97;            %efficiency of rear gearbox, optional
