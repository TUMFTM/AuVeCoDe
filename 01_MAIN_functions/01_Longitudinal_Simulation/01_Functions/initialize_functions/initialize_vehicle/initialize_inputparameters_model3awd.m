function [vehicle,Parameters] = initialize_inputparameters_model3awd(vehicle)
...
% Version: Matlab2020b
%-------------
% Description: Tesla Model 3 Long Range AWD 2020
...
vehicle.Input.vehicle_empty_weight      =   1847-75;           %empty weight netto in kg (no driver)
...
vehicle.Input.max_speed                 =   233.3;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   9;          %gear ratio front
vehicle.Input.i_gearbox_r               =   9;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  163;         %max torque of front machine in Nm
vehicle.Input.T_max_Mot_r               =  330;         %max torque of rear machine in Nm
...
vehicle.Input.acceleration_time_req     =   4.6;    %required acceleration time in s
