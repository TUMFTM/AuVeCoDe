...
vehicle.LDS.parameters.wheelbase      = vehicle.dimensions.GX.wheelbase;                                                     %wheelbase in mm
vehicle.LDS.parameters.vehicle_height = vehicle.dimensions.GZ.vehicle_height;                                                %total height in mm
vehicle.LDS.parameters.vehicle_width  = vehicle.dimensions.GY.vehicle_width;                                                 %total width in mm
vehicle.LDS.parameters.A              = vehicle.dimensions.GY.vehicle_width *vehicle.dimensions.GZ.vehicle_height*Par.LDS.correction_area;   %cross sectional area in mm^2
