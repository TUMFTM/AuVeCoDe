function [F_c,F_c_b,V_c]=Object3d_Cylinder_Middle(p,eu,r,h,sc)
%% Description:
...
%% Note: Change to normal function (Object3d_Cylinder)
...
%% Difference to Object3d_Cylinder Function: first move wheel to middle position
z_max           = max(vertices_0(:,3)); %maximum z-position
vertices_0(:,3) = vertices_0(:,3)-0.5*z_max; %move every point to middle
