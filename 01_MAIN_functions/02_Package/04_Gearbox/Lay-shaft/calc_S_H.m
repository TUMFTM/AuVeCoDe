function gearbox = calc_S_H(shaft, gearbox)
%% 1) Decription:
% This function computes the safety factor against flank break, according
% to Decker, starting p. 151
...
if (shaft==1)
    ...
    d_1 = gearbox.gears_12.d_1;                     % Pitch diameter of first wheel [mm]
...
elseif (shaft==2)
    i_12 = gearbox.results.i_34;                    % Transmission ratio of second stage [-]
    ...
    d_1 = gearbox.gears_34.d_3;                     % Pitch diameter of third wheel [mm]
...
%% 4) Output assignment:
if (shaft==1)
    gearbox.results.S_H_12 = S_H;       % Safety factor against flank break for first stage
elseif (shaft==2)
    gearbox.results.S_H_34 = S_H;       % Safety factor against flank break for second stage
end
