function gearbox = calc_S_F_plan(shaft, gearbox)
%% 1) Description:
% This function computes the safety factor against root break for planetary 
% gearboxes according to Decker, p. 150
...
if (shaft==1)
    ...
    b = gearbox.gears.b_1;                          % Width of sun gear [mm]
    ...
    m_n = gearbox.gears.m_n_2;                      % Normal module of second stage [mm]
...
%% 4) Output assignment:
if (shaft==1)
    gearbox.results.S_F_1p1 = S_F;       % Safety factor against root break for first stage
else % if shaft==2
    gearbox.results.S_F_p22 = S_F;       % Safety factor against root break for second stage
end
