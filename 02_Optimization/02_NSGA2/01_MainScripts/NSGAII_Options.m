function [options,Parameters] = NSGAII_Options(Parameters)
%% Description:
...
% Version: Matlab2020b
%-------------
% Description:  Function defines the optimization options for NSGA-II
% ------------
...
%% Implementation
    ...
    % be saved
    options.FolderName = "NSGA_II";
    % link to the NSGA-II optimization function
    options.func = @nsga2;
    % Name of the algorithm for the result
    options.Algo = "NSGA_II";
